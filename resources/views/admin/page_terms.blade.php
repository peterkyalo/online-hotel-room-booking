                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="terms_status" id="terms_status" class="form-control">
                                            <option value="1" @if ($page_data->terms_status == '1') selected @endif>Show
                                            </option>
                                            <option value="0" @if ($page_data->terms_status == '0') selected @endif>Hide
                                            </option>
                                        </select>
                                    </div>
