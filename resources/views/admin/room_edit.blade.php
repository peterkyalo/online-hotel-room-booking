                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <div>
                                            <img src="{{ asset('uploads/' . $room_data->featured_photo) }}" class="w_200"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control snote" name="description" cols="30" rows="10">
                                        ...
                                        @foreach ($all_amenities as $item)
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="{{ $item->id }}"
                                                    id="defaultCheck{{ $id }}" name="arr_amenities[]"
                                                    {{ $checked_type }}>
