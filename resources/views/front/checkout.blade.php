        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-6 checkout-left">
                    ...
                    <form action="{{ route('payments') }}" method="post" class="frm_checkout">
                        @csrf
                        @method('GET')
                            ...
                            <button type="submit" class="btn btn-primary bg-website mb_30 mt-3">Continue to payments</button>
                        </form>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>Total:</b></td>
                                            <td class="p_price"><b>Ksh {{ $total_price }}</b></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
